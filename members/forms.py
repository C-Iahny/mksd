...
from mksd.models import Profile
...
class ProfilePageForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
			'biographie': forms.Textarea(attrs={'class': 'form-control', 'placeholder': 'Decrivez-vous'}),
			#'profile_pic': forms.TextInput(attrs={'class': 'form-control', 'value':'', 'id':'Ihany', 'type': 'hidden'}),
